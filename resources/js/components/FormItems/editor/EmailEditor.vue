<template>
  <div
    ...
    v-bind:style="{ minHeight: minHeight ,minWidth :minWidth}"
  ></div>
</template>


<script>
import { loadScript } from 'vue-email-editor/src/components/loadScript';
import pkg from 'vue-email-editor/package.json';
