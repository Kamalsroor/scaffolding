        ...
        <div class="md:grid md:grid-cols-12 md:gap-6">
          ...
          <div class="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6">
            ...
            <div class="mb-8 md:mb-0">
              ...
              <a :class="tab !== '3' ? 'bg-white shadow-md border-gray-200 hover:shadow-lg' : 'bg-gray-200 border-transparent'" class="flex items-center text-lg p-5 rounded border transition duration-300 ease-in-out" href="#0" @click.prevent="tab = '3'">
                <div>
                  <div class="font-bold leading-snug tracking-tight mb-1">Building the Simple ecosystem</div>
                  <div class="text-gray-600">Take collaboration to the next level with security and administrative features built for teams.</div>
                </div>
            ...
            <div class="relative flex flex-col text-center lg:text-right">
              ...
              >
                <div class="w-full"  v-show="tab === '1'">
                  <div class="relative inline-flex flex-col">
                    <img class="md:max-w-none mx-auto rounded" :src=" '/storage/consol/images/features-home-bg-01.png'" width="500" height="375" alt="Features bg" />
                    <img class="md:max-w-none absolute w-full left-0 transform animate-float" :src=" '/storage/consol/images/features-home-element-01.png'" width="500" height="147" alt="Element 01" style="top:22%" />
                    <img class="md:max-w-none absolute w-full left-0 transform animate-float animation-delay-500" :src=" '/storage/consol/images/features-home-element-02.png'" width="500" height="158" alt="Element 02" style="top:39%" />
                    <img class="md:max-w-none absolute w-full left-0 bottom-0 transform animate-float animation-delay-1000" :src=" '/storage/consol/images/features-home-element-03.png'" width="500" height="167" alt="Element 03" style="top:77%" />
                  </div>
                </div>
              </transition>
              <!-- Item 2 -->
              ...
              >
                <div class="w-full"  v-show="tab === '2'">
                  <div class="relative inline-flex flex-col">
                    <img class="md:max-w-none mx-auto rounded" :src=" '/storage/consol/images/features-home-bg-01.png'" width="500" height="375" alt="Features bg" />
                    <img class="md:max-w-none absolute w-full left-0 bottom-0 transform animate-float animation-delay-1000" :src=" '/storage/consol/images/features-home-element-03.png'" width="500" height="167" alt="Element 03" style="top:18%" />
                    <img class="md:max-w-none absolute w-full left-0 transform animate-float animation-delay-500" :src=" '/storage/consol/images/features-home-element-02.png'" width="500" height="158" alt="Element 02" style="top:40%" />
                    <img class="md:max-w-none absolute w-full left-0 transform animate-float" :src=" '/storage/consol/images/features-home-element-01.png'" width="500" height="147" alt="Element 01" style="top:79%" />
                  </div>
                </div>
              </transition>
              <!-- Item 3 -->
