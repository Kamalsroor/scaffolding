<template>
  <section class="relative">
    ...
    <div aria-hidden="true" class="absolute left-1/2 transform -translate-x-1/2 bottom-0 mb-20 pointer-events-none">
      <svg height="365" width="1360" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <defs>
          <filter id="scill-sh" filterUnits="objectBoundingBox" height="200%" width="200%" x="-50%" y="-25%">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-16">
          <h2 class="h2 mb-4" data-aos="zoom-y-out">WSA Success Partners</h2>
          <p class="text-xl text-gray-600">World Shipping Alliance is proudly a partner with the top freight forwarders
            and business platforms to give you the best experience.</p>
        </div>
        ...
        <div class="max-w-sm md:max-w-4xl mx-auto grid gap-2 grid-cols-4 md:grid-cols-5">
          ...
          <div class="flex items-center justify-center py-2 col-span-2 md:col-auto">
            <svg class="max-w-full fill-current text-gray-400" height="24" viewBox="0 0 124 24" width="124"
          ...
          <!-- Item -->
          <div class="flex items-center justify-center py-2 col-span-2 md:col-auto">
            <svg class="max-w-full fill-current text-gray-400" height="30" viewBox="0 0 83 30" width="83"
                 xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <!-- Item -->
          <div class="flex items-center justify-center py-2 col-span-2 md:col-auto">
            <svg class="max-w-full fill-current text-gray-400" height="39" viewBox="0 0 125 39" width="125"
                 xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <!-- Item -->
          <div class="flex items-center justify-center py-2 col-span-2 md:col-auto">
            <svg class="max-w-full fill-current text-gray-400" height="30" viewBox="0 0 113 30" width="113"
                 xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <div class="flex items-center justify-center py-2 col-span-2 md:col-auto col-start-2 col-end-4">
            <svg class="max-w-full fill-current text-gray-400" height="33" viewBox="0 0 109 33" width="109"
                 xmlns="http://www.w3.org/2000/svg">
              <path
        ...
        <div class="max-w-3xl mx-auto">
          ...
          <div class="relative mt-20" data-aos="zoom-y-out">
            ...
            <!-- Testimonials -->
            <transition-group class="relative flex items-start border-2 border-gray-200 rounded bg-white z-10" enter-active-class="transition ease-in-out duration-700 transform order-first"
                              enter-from-class="opacity-0 -translate-y-8"
                              enter-to-class="opacity-100 translate-y-0" leave-active-class="transition ease-in-out duration-300 transform absolute"
                              leave-from-class="opacity-100 translate-y-0"
                              leave-to-class="opacity-0 translate-y-8" tag="div">
                ...
                >
                  <div class="absolute top-0 -mt-8 left-1/2 transform -translate-x-1/2">
                    <svg aria-hidden="true"
                         class="absolute top-0 right-0 -mt-3 -mr-8 w-16 h-16 fill-current text-green-500" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                      <path
                        d="M37.89 58.338c-2.648-5.63-3.572-10.045-2.774-13.249.8-3.203 8.711-13.383 23.737-30.538l2.135.532c-6.552 10.033-10.532 17.87-11.939 23.515-.583 2.34.22 6.158 2.41 11.457l-13.57 8.283zm-26.963-6.56c-2.648-5.63-3.572-10.046-2.773-13.25.799-3.203 8.71-13.382 23.736-30.538l2.136.533c-6.552 10.032-10.532 17.87-11.94 23.515-.583 2.339.22 6.158 2.41 11.456l-13.57 8.283z"/>
                    </svg>
                    <img :alt="item.alt" :src="item.img" class="relative rounded-full" height="96" width="96"/>
                  </div>
                  ...
                  <div class="text-gray-600">
                    <span>{{ item.role }}</span> <a :href="item.link"
                                                    class="text-[#1b7035] hover:underline">{{ item.team }}</a>
                  </div>
                </div>
              </template>
            </transition-group>
...
export default {
  ...
  data: function () {
    return {
      ...
      items: [
        {
          img: '../storage/consol/images/testimonial-01.jpg',
          alt: 'Testimonial 01',
          quote:
        ...
        {
          img: '../storage/consol/images/testimonial-02.jpg',
          alt: 'Testimonial 02',
          quote:
        ...
        {
          img: '../storage/consol/images/testimonial-03.jpg',
          alt: 'Testimonial 03',
          quote:
