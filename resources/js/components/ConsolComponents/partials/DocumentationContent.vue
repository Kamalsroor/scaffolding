<template>
  <div class="md:flex-grow">
    ...
    <div class="text-lg text-gray-600">
      <h2 class="h2 text-text-primary mb-4">Introduction to Simple</h2>
      <p class="mb-8">
        Aenean sed adipiscing diam donec <strong class="font-medium text-text-primary">adipiscing tristique
        risus</strong>
        nec feugiat auctor urna nunc id cursus metus aliquam eleifend, arcu dictum varius duis at consectetur lorem
        donec massa sapien, sed risus ultricies tristique nulla aliquet. <strong class="font-medium text-text-primary">Morbi
        tristique senectus</strong> et netus et, nibh nisl condimentum id venenatis a condimentum vitae sapien.
      </p>
      <h3 id="installation" class="h3 text-text-primary mb-4" style="scroll-margin-top: 100px;">Installation</h3>
      <p class="mb-8">
        Sit amet cursus sit amet dictum sit amet. Mattis pellentesque id nibh tortor id nulla aliquet porttitor lacus
        luctus accumsan, tortor posuere pellentesque habitant morbi tristique senectus et netus. Lacinia quis vel eros
        donec ac odio tempor duis ut diam quam nulla. Tellus orci ac auctor augue mauris augue.
      </p>
      <figure class="mb-8">
        <img :src=" '/storage/consol/images/docs-image-01.png'" alt="Docs 01" class="w-full rounded"
             height="390" width="768"/>
      </figure>
      <p class="mb-8">
        Sit amet cursus sit amet dictum sit amet mattis pellentesque id nibh tortor id, nulla aliquet porttitor lacus
        luctus accumsan tortor posuere. <strong class="font-medium text-text-primary">Pellentesque habitant
        morbi</strong>
        tristique senectus et netus, lacinia quis vel eros donec ac odio tempor. Duis ut diam quam nulla tellus orci ac
        auctor augue mauris augue.
      </p>
      <p
        class="flex items-center text-base px-3 py-4 text-text-primary bg-green-100 border border-green-200 rounded mb-8">
        <svg class="w-4 h-4 fill-current text-green-500 flex-shrink-0 mr-2" xmlns="http://www.w3.org/2000/svg">
          <path
            ...
            fill="#338CF5" fill-rule="nonzero"/>
        </svg>
        <span>Check out the <a class="text-[#1b7035] hover:underline" href="#0">Terms and license page</a> to know more about our license.</span>
      </p>
      <h3 id="quick" class="h3 text-text-primary mb-8" style="scroll-margin-top: 100px;">Quick start</h3>
      <h4 class="h4 text-text-primary mb-4">Customising settings</h4>
      <p class="mb-8">
        Orci ac auctor augue mauris augue neque gravida in sapien faucibus et molestie ac feugiat sed lectus vestibulum
        mattis senectus et <a class="text-text-primary underline" href="#0">netus et malesuada fames</a> ut faucibus
        pulvinar elementum integer pellentesque habitant morbi.
      </p>
      <figure class="mb-8">
        <img :src=" '/storage/consol/images/docs-image-02.png'" alt="Docs 02" class="w-full rounded"
             height="390" width="768"/>
      </figure>
      <p class="mb-8">
        Aenean sed adipiscing diam donec adipiscing tristique risus nec feugiat auctor urna nunc id cursus metus aliquam
        eleifend, arcu dictum varius duis at consectetur lorem donec massa sapien, sed risus ultricies tristique nulla
        aliquet. Morbi tristique senectus et netus et, nibh nisl condimentum id venenatis a condimentum vitae sapien.
      </p>
      <p
        class="flex items-center text-base px-3 py-4 text-text-primary bg-green-100 border border-green-200 rounded mb-8">
        <svg class="w-4 h-4 fill-current text-green-500 flex-shrink-0 mr-2" xmlns="http://www.w3.org/2000/svg">
        ...
        <span>Learn more about <a class="text-[#1b7035] hover:underline" href="#0">Customising settings</a>.</span>
      </p>
      <h3 id="folder" class="h3 text-text-primary mb-8" style="scroll-margin-top: 100px;">Folder content</h3>
      <p class="mb-8">
        Aenean sed adipiscing diam donec adipiscing tristique risus nec feugiat auctor urna nunc id cursus metus aliquam
        eleifend, arcu dictum varius duis at consectetur lorem donec massa sapien, sed risus ultricies tristique nulla
        aliquet. Morbi tristique senectus et netus et, nibh nisl condimentum id venenatis a condimentum vitae sapien.
    ...
    <div class="mt-8">
      ...
      <a
        class="flex justify-between items-center p-4 rounded border border-gray-200 transition duration-300 ease-in-out bg-white shadow-md hover:shadow-lg mb-4"
        href="#0">
        <div>
        ...
        <svg class="w-4 h-4 fill-current text-[#1b7035] flex-shrink-0 ml-6" viewBox="0 0 16 16"
        ...
        <ul class="inline-flex justify-center -m-2">
            ...
            <a href="#0" title="No, at all">
              <svg class="w-6 h-6" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <path
                  ...
                  fill="#664500"/>
                <path d="M6.667 16.667S8.667 16 12 16s5.333.667 5.333.667S16 14 12 14s-5.333 2.667-5.333 2.667z"
                      fill="#FFF"/>
              </svg>
            </a>
          </li>
          <li class="p-2">
            <a href="#0" title="Not really">
              <svg class="w-6 h-6" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <circle cx="12" cy="12" fill="#FFCC4D" r="12"/>
                <circle cx="16.333" cy="9" fill="#F4F7F9" r="3.667"/>
                <circle cx="7.667" cy="9" fill="#F4F7F9" r="3.667"/>
                <path
