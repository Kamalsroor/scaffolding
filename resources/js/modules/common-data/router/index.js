...
import MainLayout from "@/modules/common-data/views/index.vue";
  ...
  children: [
    {
      path: "/common-data/services",
      name: "services",
      component: () => import(/* webpackChunkName: "coomon_data_services" */'@/modules/common-data/views/Services.vue'),
      meta: {
        title: 'Services',
        // icon: 'admin',
    ...
    },
    {
      ...
      name: "certificates",
      component: () => import(/* webpackChunkName: "coomon_data_certificates" */'@/modules/common-data/views/Certificates.vue'),
      meta: {
        title: 'Certificates',
        // icon: 'admin',
    ...
    },
    {
      ...
      name: "sliders",
      component: () => import(/* webpackChunkName: "coomon_data_sliders" */'@/modules/common-data/views/Sliders.vue'),
      meta: {
        title: 'Sliders',
        // icon: 'admin',
    ...
    },
    {
      ...
      name: "countries",
      component: () => import(/* webpackChunkName: "coomon_data_countries" */'@/modules/common-data/views/Countries.vue'),
      meta: {
        title: 'Countries',
        // icon: 'admin',
    ...
    },
    {
      ...
      name: "referrals",
      component: () => import(/* webpackChunkName: "coomon_data_referrals" */'@/modules/common-data/views/Referrals.vue'),
      meta: {
        title: 'Referrals',
        // icon: 'admin',
