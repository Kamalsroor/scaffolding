<template>
  ...
  <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    ...
    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
      <a class="btn btn-primary shadow-md mr-2" v-can="['create-service']" @click="OpenNewServiceModal()">
      ...
      <Modal v-can="['create-service','edit-service']" :show="ModelIsOpen" size="modal-xl" @hidden="closeModel()">
        <form class="validate-form" @submit.prevent="save">
          ...
          <ModalBody class="grid grid-cols-12 gap-8 gap-y-4">
            <InputField v-model="service.name" :errors="v$.service.name.$errors" class="col-span-12 sm:col-span-4"
                        :label="$t('forms.attributes.name')" name="name" :placeholder="$t('forms.attributes.name')"/>
            <InputField v-model="service.order_id" type="number" :errors="v$.service.order_id.$errors" class="col-span-12 sm:col-span-4"
                        :label="$t('forms.attributes.order_id')" name="order_id" :placeholder="$t('forms.attributes.order_id')"/>
            <Switch v-model="service.active" :errors="v$.service.name.$errors" class="col-span-12 sm:col-span-4"
...
import ServiceController from '@/modules/common-data/controllers/ServiceController.js';
