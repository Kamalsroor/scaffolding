...
class CountrySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $bar->start();
        $module_path = module_path('CommonData');
        // dd($module_path , $module_path."\Resources\countries" , public_path('countries'));
        $countries_path = $module_path."\Resources\countries";
            ...
            if (File::exists($countries_path.`\{$code}.svg`)) {
                foreach ($files as $key => $file) {
                    if ($file->getBasename('.svg') == $code) {
                        ...
                        // dd( $file->getBasename() ,$file->getExtension() , $file->getFilename() , $file->getPath() , $file->getType() , $file->getSize() ,$file );
     ...
     *
     */
    public function countriesWithFlag()
    {
        $countries = [
        [
            'name' => 'Afghanistan' ,
