        ...
        try{
            if($ip){
                ...
                return [
                    ...
                    'country_flag'=>"Not specified",
                    'country_code'=>"404"
                ];
            }

			if($location->countryName == '' || $location->countryName === null ){
			
				$country =  Country::whereCode($location->countryCode)->first();
				$location->countryName =  $country ? $country->name :"Not specified" ;
			}

            return [
                'country'=>$location->countryName,
                'country_flag'=> 'https://wsa-events.com/countries/'.strtolower($location->countryCode).'.svg',
